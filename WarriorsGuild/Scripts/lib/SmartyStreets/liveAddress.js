        ...
        this.showAmbiguous = function (aa) {
            ...
            if (ae.isDomestic()) {
                for (var ab = 0; ab < Y.raw.length; ab++) {
                    var ag = Y.raw[ab].delivery_line_1
                        , Z = Y.raw[ab].components.city_name
                        , ah = Y.raw[ab].components.state_abbreviation
                        , X = Y.raw[ab].components.zipcode + "-" + Y.raw[ab].components.plus4_code;
