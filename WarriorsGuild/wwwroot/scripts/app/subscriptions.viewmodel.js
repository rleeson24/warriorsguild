...
(function (WarriorsGuild) {
    var SubscriptionsViewModel = /** @class */ (function () {
        function SubscriptionsViewModel(app) {
            var _this = this;
            this.getMySubscription = function () {
                var self = _this;
                $.ajax({
                    method: 'get',
            ...
            this.createReadOnlySubscription = function (data) {
                var model = new WarriorsGuild.Payments.ReadOnlySubscription();
                ...
                model.setupFee = koCustom.currencyComputed(data.setupFee);
                model.charge = koCustom.currencyComputed(data.charge);
                model.additionalCostPerGuardian = koCustom.currencyComputed(data.additionalCostPerGuardian);
                model.totalAdditionalGuardianCost = koCustom.currencyComputed(data.additionalCostPerGuardian * data.additionalGuardians);
                model.additionalCostPerWarrior = koCustom.currencyComputed(data.additionalCostPerWarrior);
                model.totalAdditionalWarriorCost = koCustom.currencyComputed(data.additionalCostPerWarrior * data.additionalWarriors);
                model.totalPeriodicCharge = koCustom.currencyComputed(_this.sumCurrency(data.charge, (data.additionalGuardians * data.additionalCostPerGuardian), (data.additionalWarriors * data.additionalCostPerWarrior)));
            ...
            Sammy(function () {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (i, d) {
                                ...
                                d.additionalGuardianPlan["quantity"] = ko.observable(0);
                                d.additionalGuardianPlan["formattedCharge"] = koCustom.currencyComputed(d.additionalGuardianPlan.charge);
                                d.additionalGuardianPlan['totalCharge'] = koCustom.currencyComputed(function () {
                                    return (this.charge * 100 * this.quantity()) / 100;
                                }, d.additionalGuardianPlan);
                                d.additionalWarriorPlan["quantity"] = ko.observable(0);
                                d.additionalWarriorPlan["formattedCharge"] = koCustom.currencyComputed(d.additionalWarriorPlan.charge);
                                d.additionalWarriorPlan['totalCharge'] = koCustom.currencyComputed(function () {
                                    return (this.charge * 100 * this.quantity()) / 100;
                                }, d.additionalWarriorPlan);
                                d["formattedCharge"] = koCustom.currencyComputed(d.charge);
                                d["formattedSetupFee"] = koCustom.currencyComputed(d.setupFee);
                                d["subTotal"] = koCustom.currencyComputed(function () {
                                    return self.sumCurrency(this.charge, this.additionalGuardianPlan.totalCharge(), this.additionalWarriorPlan.totalCharge());
                                }, d);
                                d["totalCharge"] = koCustom.currencyComputed(function () {
                ...
                this.get('/Subscription/:pageLoadPriceOptionId', function () {
                    var pageLoadPriceOptionId = this.params['pageLoadPriceOptionId'];
    ...
    WarriorsGuild.SubscriptionsViewModel = SubscriptionsViewModel;
...
//	} );
//};
//# sourceMappingURL=subscriptions.viewmodel.js.map